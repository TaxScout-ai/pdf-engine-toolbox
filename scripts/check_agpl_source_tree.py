...
def main() -> int:
    ...
    require('RUNTIME_LICENSE_IDENTIFIER = "AGPL-3.0-only"' in
            (ROOT / "app/build_identity.py").read_text(encoding="utf-8"),
            "combined runtime license is inaccurate")
    require('PROJECT_LICENSE_IDENTIFIER = "AGPL-3.0-or-later"' in
            (ROOT / "app/build_identity.py").read_text(encoding="utf-8"),
